...
export function PhoneVerification() {
  ...
  const handleSocialMediaShare = async (platform: string, urlOrHandler: string) => {
    try {
      const shareText = "Chismea mensajes anónimos a toda le Tec " + window.location.href;
  ...
  return (
    <>
      <div className='flex flex-col items-center justify-center gap-12 !mt-20'>
        <p className='text-xs font-bold my-2'>Not affiliated with Tec de Monterrey</p>
        <Card className="p-4 text-center max-w-md">
          <h3 className="text-lg font-semibold mb-4">
            Revela los secretos del Tec <br />
